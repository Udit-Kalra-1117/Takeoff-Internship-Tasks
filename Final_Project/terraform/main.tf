...
resource "google_storage_bucket" "udit-grocery-items-images-final-project-bucket" {
    name = "udit-grocery-items-images-final-project-bucket"
...
resource "google_storage_bucket_iam_member" "member" {
    bucket = google_storage_bucket.udit-grocery-items-images-final-project-bucket.name
    role = "roles/storage.objectViewer"
    member = "allUsers"
}

// creating a bucket for storing cloud functions zip files
resource "google_storage_bucket" "udit-grocery-items-cloud-functions-final-project-bucket" {
    name = "udit-grocery-items-cloud-functions-final-project-bucket"
    location = var.location
    storage_class = "STANDARD"
    uniform_bucket_level_access = true
    force_destroy = true
...
resource "google_storage_bucket_object" "create-an-item-code" {
    ...
    bucket = google_storage_bucket.udit-grocery-items-cloud-functions-final-project-bucket.name
...
resource "google_storage_bucket_object" "get-all-items-code" {
    ...
    bucket = google_storage_bucket.udit-grocery-items-cloud-functions-final-project-bucket.name
    source = "../artifacts/get_all_function-source.zip"
}
